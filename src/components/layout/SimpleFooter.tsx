...
export function SimpleFooter({ current }: { current: string }) {
  return (
    <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
      ...
      <nav
        className="-mb-6 flex flex-col flex-wrap gap-x-12 gap-y-3 text-center text-sm/6 sm:flex-row sm:justify-center"
        aria-label="Footer"
      >
          ...
          <Link
            ...
            className={
              href === current
                ...
                : 'text-gray-800 hover:text-subPurple'
            }
      ...
      <p className="mt-10 text-center font-sans text-sm/6 text-gray-600">
